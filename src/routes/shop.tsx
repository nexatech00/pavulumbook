...
export const Route = createFileRoute("/shop")({
  head: () => ({
    meta: [
      { title: "Shop — Pavulum" },
      { name: "description", content: "Books, courses, and apparel from Pavulum." },
      { property: "og:title", content: "Shop — Pavulum" },
      { property: "og:description", content: "Books, courses, and apparel from Pavulum." },
    ],
    ...
    <SiteLayout>
      <div className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-16 text-center">
          <Link to="/" className="text-terracotta hover:underline">← Back home</Link>
        </div>
      </div>
    </SiteLayout>
  );
