      ...
      <div className="border-t border-cream/10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 py-6 md:flex-row">
          ...
          <div className="flex items-center gap-4 text-soft-gold">
            ...
            <a href="#" aria-label="Spotify" className="hover:text-cream">
              <Music2 className="h-4 w-4" />
            </a>
            <a href="#" aria-label="YouTube" className="hover:text-cream">
              <Youtube className="h-4 w-4" />
            </a>
            <a href="#" aria-label="Substack" className="hover:text-cream">
