      ...
      <SiteLayout>
        <div className="mx-auto max-w-2xl px-6 py-24 text-center">
          ...
          <p className="mt-4 text-charcoal/75">
            Your account ({user.email}) doesn't have admin access. Ask the owner to grant
            the{" "}
      ...
      <header className="border-b border-border bg-card">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
          <div className="flex items-center gap-8">
            <Link href="/" className="font-serif text-lg text-deep-brown">
              PAVULUM · Admin
            </Link>
              ...
              {links.map((l) => {
                ...
                return (
                  <Link
                    ...
                    href={l.href}
                    className={
                      active ? "text-terracotta" : "text-charcoal/75 hover:text-terracotta"
                    }
                  >
                    {l.label}
                  </Link>
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <Link href="/" className="text-charcoal/70 hover:text-terracotta">
              View site
            </Link>
            <button
              onClick={() => signOut()}
