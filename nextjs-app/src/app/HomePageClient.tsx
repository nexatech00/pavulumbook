  ...
  return (
    <SiteLayout>
      ...
      >
        ...
        <ViewAll href="/books" label="View all books" />
      </Section>
      ...
      <Section eyebrow="Courses" title="Learn at your own pace">
        ...
        <ViewAll href="/courses" label="View all courses" />
      </Section>

      {/* APPAREL */}
      <section className="relative my-24 w-full overflow-hidden">
        <Image src={APPAREL_BG} alt="" fill className="object-cover" />
      ...
      <Section eyebrow="Journal" title="Reflections">
        <div className="mx-auto max-w-2xl divide-y divide-border/70">
          {essays.map((e) => (
            <Link key={e.slug} href="/journal" className="group block py-7">
        ...
        <ViewAll href="/journal" label="Read all essays" />
      </Section>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-8">
              <Link href="/podcast" className="text-terracotta hover:underline">
                See all episodes →
              </Link>
            </div>
          </div>
      ...
      <section className="paper-grain bg-secondary/40">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-24 md:grid-cols-2">
          <div>
            ...
            <Link href="/about" className="mt-6 inline-block text-terracotta hover:underline">
              Read my story →
            </Link>
          </div>
